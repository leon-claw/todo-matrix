...
```text
https://todo-matrix.jianghong.site/ota/android/manifest.json
https://todo-matrix.jianghong.site/ota/windows/manifest.json
```

所以服务器上需要有一个静态目录映射到：

```text
https://todo-matrix.jianghong.site/ota/
```
...
```powershell
curl.exe https://todo-matrix.jianghong.site/ota/android/manifest.json
curl.exe https://todo-matrix.jianghong.site/ota/windows/manifest.json
```
...
```text
https://todo-matrix.jianghong.site/ota/android/manifest.json
https://todo-matrix.jianghong.site/ota/android/2026.06.05.1/dist.zip
```
...
```json
{
  ...
  "nativePolicy": "none",
  "webPolicy": "silent",
  "webBundleUrl": "https://todo-matrix.jianghong.site/ota/android/2026.06.05.1/dist.zip",
  "sha256": "..."
}
```
...
```text
https://todo-matrix.jianghong.site/ota/windows/manifest.json
https://todo-matrix.jianghong.site/ota/windows/2026.06.05.1/dist.zip
```
...
```text
https://todo-matrix.jianghong.site/api
```

如果要临时指定其他生产 API：

```powershell
$env:WECHAT_API_BASE_URL="https://todo-matrix.jianghong.site/api"
npm run build:wechat
```
