...
const PRODUCTION_API_BASE_URL = process.env.TODO_MATRIX_API_BASE_URL || 'https://todo-matrix.jianghong.site/api';
const PRODUCTION_OTA_MANIFEST_URL = process.env.TODO_MATRIX_OTA_MANIFEST_URL || 'https://todo-matrix.jianghong.site/ota/android/manifest.json';
...
export default defineConfig(({ mode }) => {
  ...
  return {
    ...
    define: {
      ...
      __TODO_MATRIX_API_BASE_FALLBACK__: JSON.stringify(process.env.TODO_MATRIX_API_BASE || ''),
